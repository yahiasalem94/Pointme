...
public class LocationTrack extends Service implements LocationListener {
                ...
                if (checkGPS) {
                    ...
                    if (locationManager != null) {
                        ...
                        if (loc != null) {
                            ...
                            Log.d(TAG, "Using GPS Latitude is " + latitude + " Longitude is " + longitude);
                        }
                    }

                }
                if (checkNetwork && latitude == 0.0 && longitude == 0.0) {
                    ...
                    if (loc != null) {
                        latitude = loc.getLatitude();
                        longitude = loc.getLongitude();
                        Log.d(TAG, "Using Network Latitude is " + latitude + " Longitude is " + longitude);
                    }
                }
    ...
    public void showSettingsAlert() {
        ...
        alertDialog.setTitle(mContext.getResources().getString(R.string.turn_on_gps));
