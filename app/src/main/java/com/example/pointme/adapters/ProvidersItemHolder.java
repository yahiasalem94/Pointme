...
public class ProvidersItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ProvidersItemHolder(View itemView, ProvidersAdapter.ProvidersAdapterOnClickHandler mClickHandler) {
        super(itemView);
